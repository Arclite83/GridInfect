...
namespace GridInfect.Game
{
    ...
    public sealed class MainMenuScreen : AppScreen
    {
        ...
        protected override void Build()
        {
            ...
            Buttons.Add(UiButton.Make(Root.transform, "CLASSIC",
                new Vector2(0f, L.StackRowY(0, 2, L.ButtonHeight, 0f)), size,
            ...
            Buttons.Add(UiButton.Make(Root.transform, "FREE PLAY",
                new Vector2(0f, L.StackRowY(1, 2, L.ButtonHeight, 0f)), size,
