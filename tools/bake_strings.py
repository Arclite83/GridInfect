...
adapter compile-check sees. See ARCHITECTURE.md §8.
...
def display_width(text):
    ...
    draws, not how many code points it has (ARCHITECTURE.md §8)."""
...
def emit(keys, tables, tags):
    ...
    add("// Do not edit; regenerate. The rules are ARCHITECTURE.md §8.")
    ...
    add("        // list minus the pseudolocales (ARCHITECTURE.md §8).")
