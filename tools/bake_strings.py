...
adapter compile-check sees. See docs/I18N.md 4.
...
Two pseudolocales are generated, never authored (docs/I18N.md 9):
...
def emit(keys, tables, tags):
    ...
    add("        // list minus the pseudolocales (docs/I18N.md 9).")
