...
namespace UnityEngine
{
    ...
    public static class Mathf { public const float PI = MathF.PI; public const float Deg2Rad = PI / 180f;
        ...
        public static float Exp(float v) => MathF.Exp(v); public static float Lerp(float a, float b, float t) => a + (b - a) * Clamp01(t); public static float Clamp(float v, float a, float b) => v < a ? a : v > b ? b : v; }
    ...
    public class Object { public string name { get; set; } public HideFlags hideFlags { get; set; }
        public static void Destroy(Object o) { } public static T Instantiate<T>(T o) where T : Object => o; }
    ...
    public sealed class Sprite : Object { public Texture2D Tex; public Texture2D texture => Tex; public static Sprite Create(Texture2D t, Rect r, Vector2 p, float ppu) => new Sprite { Tex = t }; }
